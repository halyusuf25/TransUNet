...
from utils import test_single_volume, count_parameters, calculate_inference_latency, evaluate_model_perf, measure_model_metrics, vision_transformer_flops
...
if __name__ == "__main__":
    ...
    vision_transformer_flops(net, config=config_vit, use_shsa=args.use_shsa)
